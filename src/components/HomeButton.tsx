...
export function HomeButton() {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      aria-label="Acasă"
      className="fixed z-[60] bottom-4 left-4 w-11 h-11 rounded-full glass border border-gold/25 flex items-center justify-center text-white/85 active:scale-95 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.6)] backdrop-blur-md"
    >
