    ...
    <PhoneShell>
      ...
      <div className="relative z-10 flex flex-col h-full px-6 pt-4 pb-6">
        ...
        <div className="flex-1 flex flex-col mt-6 overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {step === 0 && <StepLogo logoUrl={localLogoUrl} onPick={onPickLogo} fileRef={fileRef} />}
...
function StepLogo({ logoUrl, onPick, fileRef }: { logoUrl: string | null; onPick: (f?: File | null) => void; fileRef: React.RefObject<HTMLInputElement | null> }) {
  return (
    <div>
