    ...
    <PhoneShell>
      ...
      <div className="relative z-10 flex flex-col h-full px-7 pb-10 pt-3">
        ...
        <div className="mt-auto">
          <p className="text-xs tracking-[0.4em] uppercase mb-5 font-medium text-gold-gradient">
            Scena 0 — Start
          </p>
          <h1 className="h1-lux text-[68px] text-white">
            Ce filmăm<br />
            <em className="italic font-editorial text-gold-gradient">azi?</em>
          </h1>
          ...
          <Link
            to="/profession"
            onClick={() => light()}
            className="mt-10 group flex items-center justify-between gap-4 w-full rounded-full bg-white text-black pl-7 pr-2 py-2 shadow-gold pulse-gold active:scale-[0.98] transition"
          >
            <span className="font-medium text-base">Înainte</span>
            <span className="flex items-center justify-center w-12 h-12 rounded-full bg-black text-white group-active:bg-gold group-active:text-black transition">
